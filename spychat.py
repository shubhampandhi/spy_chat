...
from spy_detail import spy, Spy, ChatMessage, friends     #using import fxn
from steganography.steganography import Steganography
#using import fxn
from datetime import datetime

STATUS_MESSAGES = ['busy', 'at gym',"hey! i'm using spy chat ", 'watching movie']        #old status for user
...
if existing == "y":                                      #if user is old then take the old information through import fxn
     from spy_detail import spy_name, spy_salutation, spy_age, spy_ratting
     ...
     if spy.name == str(spy.name):
      ...
      print"enter name in chracter"
      from spy_detail import a,b,c,d
     start_chat(spy)
